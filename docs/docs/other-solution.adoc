...
. https://github.com/eventuate-tram/eventuate-tram-sagas[eventuate-tram/eventuate-tram-sagas: Sagas for microservices^]
...
. https://github.com/liuyangming/ByteTCC[liuyangming/ByteTCC: ByteTCC is a distributed transaction manager based on the TCC(Try/Confirm/Cancel) mechanism.^]
. https://github.com/apache/servicecomb-saga-actuator[apache/servicecomb-saga-actuator: Apache ServiceComb Saga Actuator^]
